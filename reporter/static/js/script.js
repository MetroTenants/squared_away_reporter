      ...
      return tooltip
        ...
        .html(
          "<b>" +
            tooltA +
            "</b>: " +
            d.properties[areaProp] +
            "<br><b>Count</b>: " +
            d.properties.ci_count
        );
    })
...
(function () {
  ...
  button.addEventListener("click", function () {
    ...
    var startDate = document.getElementById("start_date");
    var endDate = document.getElementById("end_date");
    var categoryValues = document.querySelectorAll(
      "#categories option:checked"
    );
    var zipCodes = document.querySelectorAll("#zip_codes option:checked");
    var includeWards = document.querySelector("#include_wards").checked;
    ...
    if (includeWards) {
      queryArgs.push("include_wards=true");
    }
    if (reportTitle) {
    ...
    document.getElementById("evictionRecordsCsvLink").href =
      "eviction-record-csv?" + queryArgs.join("&");
